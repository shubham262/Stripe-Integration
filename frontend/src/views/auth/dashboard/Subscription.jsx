...
import { createSubscription, fetchAllPlans } from "@/service/stripeService";

const { Title, Text } = Typography;

const Subscription = () => {
	// Controls whether we are looking at monthly or yearly pricing
	...
	// useEffect(() => {
	// 	// Simulated API Call to your fetchAllPlansController
		...
		<div className="min-h-screen bg-gray-50 py-12 px-6">
			<div className="max-w-5xl mx-auto">
				...
				<p className="text-center text-gray-400 mt-12 flex justify-center items-center gap-2 text-sm">
					<SiStripe className="text-xl" /> Payments are securely processed by
					Stripe.
				</p>
			</div>
		</div>
